		...
		<div class="container">
			...
			<header class="codrops-header">
				<h1> Err0r404 <span>Video Search Engine</span></h1>
				<nav class="codrops-demos">
					<div id="googlesearch">
					<form id="searchengine" method="get" action="search.php" target="_blank" name="searchtype" value="video">
					<!-- PHP part to get the datalist -->
					<input list="q" name='q'>
					<datalist id="q" name='q'>
					<?php				
					$sql1="select * from videosearchdetails ORDER BY searchcount DESC";
	...
	?>
					...
					<!-- PHP part to get the datalist -->
						<input type="submit" value="Video Search" name="searchtype">
						</form>
					</div>
				</nav>
			</header>
