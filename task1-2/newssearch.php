		...
		<div class="container">
			...
			<header class="codrops-header">
				<h1> Err0r404 <span>News Search Engine</span></h1>
				<nav class="codrops-demos">
					...
					<?php				
					$sql1="select * from newssearchdetails ORDER BY searchcount DESC";
	...
	?>
					...
					<!-- PHP part to get the datalist -->
						<input type="submit" value="News Search" name="searchtype">
						</form>
					</div>
				</nav>
			</header>
